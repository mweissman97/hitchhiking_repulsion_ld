...
* C_diff_pi_windows.tsv: average nucleotide diversity (pi) calculated in sliding windows
* C_diff_full_scan.txt: result of running [iLDS pipelin](https://github.com/garudlab/iLDS)
* figures_cdiff.R: R files used to create all figures related to *C. difficile*; Figure 4, Supplemental Figure 4. This includes plotting iLDS results, pi in sliding windows, rN - rS graphs for all sweeps, and haplotype visualizations.
